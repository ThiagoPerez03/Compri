...
const LengthTable = ({ data: algorithmDetails }) => {
    ...
    const previewData = {
        ...
        datasets: [{
            ...chartDatasetOptions,
            data: algorithmDetails.tabla_codigos.slice(0, MAX_LABELS_PREVIEW).map(e => e.codigo.length),
        }]
    };
    ...
    const fullData = {
        ...
        datasets: [{ 
            ...chartDatasetOptions,
            data: algorithmDetails.tabla_codigos.map(e => e.codigo.length) 
        }]
    };
    ...
    const modalOptions = {
        ...
        scales: {
            ...
            y: {
                display: true,
                grid: { color: '#e0e0e0' },
                ticks: { color: 'rgba(43, 54, 116, 1)', font: { size: 12 }, stepSize: 1 }
            }
        }
    };
        ...
        <>
            <Card className="chart-card">
                <Card.Header className="chart-header">
                    <h5 className="chart-title">Longitud</h5>
            ...
            <Modal show={showModal} onHide={() => setShowModal(false)} size="xl" centered>
                <Modal.Header closeButton>
                    <Modal.Title>Gráfico de Longitud de Códigos (Expandido)</Modal.Title>
                </Modal.Header>
                <Modal.Body>
